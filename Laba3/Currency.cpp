...
void Currency::Print(Singleton* log) {
	...
	cout << "\t" << GetKaz() << ".00 (казахстанский тенге)" << endl;
	cout << "\t" << GetKvacha() << ".00 (замбийская квача)" << endl;
	cout << "\t" << GetKirgiz() << ".00 (киргизская сома)" << endl;
	cout << "\t" << GetUkrain() << ".00 (украинская гривна)" << endl;
	cout << "\t" << GetMyanma() << ".00 (мьянманский кьят)" << endl;
...
double Currency::Choice() {
	...
	cout << "\t2 - " << GetKvacha() << endl << "\t*минимальная доступная сумма: 70 квач" << endl;;
	cout << "\t3 - " << GetKirgiz() << endl << "\t*минимальная доступная сумма: 350 сом" << endl;;
	cout << "\t4 - " << GetUkrain() << endl << "\t*минимальная доступная сумма: 110 гривен" << endl;;
	cout << "\t5 - " << GetMyanma() << endl << "\t*минимальная доступная сумма: 7770 кьят" << endl;
	cin >> a;
